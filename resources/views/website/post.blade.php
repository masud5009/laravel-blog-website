          ...
          <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
              ...
              <div class="post-meta align-items-center text-center">
                <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="{{asset('storage/user/'.$post->user->image)}}" alt="Image" class="img-fluid"></figure>
          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard">
                    <img src="{{ asset('storage/user/'.$post->user->image) }}" alt="Image placeholder">
                  </div>
          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                <img src="{{ asset('storage/user/'.$post->user->image) }}" alt="Image Placeholder" class="img-fluid mb-5">
                <div class="bio-body">
