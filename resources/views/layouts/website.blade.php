          ...
          <div class="col-md-4">
            ...
            <div>
              ...
              <p>
                ...
                <a href="{{$setting->reddit}}"><span class="icon-rss p-2"></span></a>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              {{$setting->copyright}} &copy; <script>document.write(new Date().getFullYear());</script>| This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="" target="_blank">Masud Rana</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
          </div>
        </div>
