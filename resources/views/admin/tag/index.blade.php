                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ $tag->slug }}</td>
                            <td class="d-flex">
                              <a href="{{ route('tag.edit',[$tag->id])}}" class="btn btn-primary mr-1 btn-sm"><i class="fas fa-edit"></i></a>
                              <form action="{{ route('tag.destroy',[$tag->id])}}" method="post">
                                @method('DELETE')
                                @csrf
                                <button class="btn btn-danger mr-1 btn-sm" type="submit"><i class="fas fa-trash"></i></button>
                              </form>
                              {{-- <a href="{{ route('tag.show',[$tag->id])}}" class="btn btn-success mr-1 btn-sm"><i class="fas fa-eye"></i></a> --}}
                            </td>
                          </tr>
                          @endforeach
                          @else
